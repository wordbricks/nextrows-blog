export const SEO_CONFIG = {
  ...
  categories: {
    technology: {
      ...
      description: 'Deep dives into NextRows architecture, integrations, and the technical decisions powering our platform.',
      keywords: ['infrastructure', 'architecture', 'engineering', 'integrations', 'technical'],
    },
    tutorials: {
      title: 'Tutorials & Guides',
      description: 'Step-by-step tutorials for web scraping, data extraction, and automation using NextRows.',
      keywords: ['tutorial', 'guide', 'how-to', 'walkthrough', 'step-by-step', 'learning'],
    },
    'use-cases': {
      title: 'Use Cases & Applications',
      description: 'Real-world examples of how businesses use NextRows for data extraction and automation.',
      keywords: ['use case', 'case study', 'real-world', 'application', 'example', 'business'],
    },
    'why-nextrows': {
      title: 'Why NextRows',
      description: 'Comparisons, benefits, and features that make NextRows the best choice for data extraction.',
      keywords: ['comparison', 'vs', 'alternative', 'benefits', 'features', 'advantages'],
    },
    others: {
      title: 'Culture & Team',
      description: 'Insights into NextRows culture, team, and our approach to building a remote-first company.',
      keywords: ['startup', 'culture', 'team', 'remote work', 'company', 'values'],
    },
  },
  authors: {
    default: {
...
export function getAuthorStructuredData(authorName: string) {
  ...
  const author = SEO_CONFIG.authors[authorKey as keyof typeof SEO_CONFIG.authors] || SEO_CONFIG.authors.default;

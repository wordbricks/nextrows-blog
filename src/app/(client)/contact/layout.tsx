...
export const metadata: Metadata = generateSEOMetadata({
  title: "Contact Us",
  description:
    "Get in touch with the NextRows team. We provide support for web scraping, data extraction, and automation questions. Response within 24 hours.",
  url: "/contact",
  keywords: [
    "contact",
    "support",
...
export default function ContactLayout({
  ...
  const contactPageStructuredData = {
    ...
    description:
      "Contact the NextRows team for support, sales inquiries, or partnership opportunities.",
    url: "/contact",
    mainEntity: {
      "@type": "Organization",
      name: "NextRows",
